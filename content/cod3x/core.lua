...
---@field WaterWalking string
---@field Shield string
---@field FireShield string
---@field LightningShield string
---@field FrostShield string
---@field Burden string
---@field Feather string
---@field Jump string
---@field Levitate string
---@field SlowFall string
---@field Lock string
---@field Open string
---@field FireDamage string
---@field ShockDamage string
---@field FrostDamage string
---@field DrainAttribute string
---@field DrainHealth string
---@field DrainMagicka string
---@field DrainFatigue string
---@field DrainSkill string
---@field DamageAttribute string
---@field DamageHealth string
---@field DamageMagicka string
---@field DamageFatigue string
---@field DamageSkill string
---@field Poison string
---@field WeaknessToFire string
---@field WeaknessToFrost string
---@field WeaknessToShock string
---@field WeaknessToMagicka string
---@field WeaknessToCommonDisease string
---@field WeaknessToBlightDisease string
---@field WeaknessToCorprusDisease string
---@field WeaknessToPoison string
---@field WeaknessToNormalWeapons string
---@field DisintegrateWeapon string
---@field DisintegrateArmor string
---@field Invisibility string
---@field Chameleon string
---@field Light string
---@field Sanctuary string
---@field NightEye string
---@field Charm string
---@field Paralyze string
---@field Silence string
---@field Blind string
---@field Sound string
---@field CalmHumanoid string
---@field CalmCreature string
---@field FrenzyHumanoid string
---@field FrenzyCreature string
---@field DemoralizeHumanoid string
---@field DemoralizeCreature string
---@field RallyHumanoid string
---@field RallyCreature string
---@field Dispel string
---@field Soultrap string
---@field Telekinesis string
---@field Mark string
---@field Recall string
---@field DivineIntervention string
---@field AlmsiviIntervention string
---@field DetectAnimal string
---@field DetectEnchantment string
---@field DetectKey string
---@field SpellAbsorption string
---@field Reflect string
---@field CureCommonDisease string
---@field CureBlightDisease string
---@field CureCorprusDisease string
---@field CurePoison string
---@field CureParalyzation string
---@field RestoreAttribute string
---@field RestoreHealth string
---@field RestoreMagicka string
---@field RestoreFatigue string
---@field RestoreSkill string
---@field FortifyAttribute string
---@field FortifyHealth string
---@field FortifyMagicka string
---@field FortifyFatigue string
---@field FortifySkill string
---@field FortifyMaximumMagicka string
---@field AbsorbAttribute string
---@field AbsorbHealth string
---@field AbsorbMagicka string
---@field AbsorbFatigue string
---@field AbsorbSkill string
---@field ResistFire string
---@field ResistFrost string
---@field ResistShock string
---@field ResistMagicka string
---@field ResistCommonDisease string
---@field ResistBlightDisease string
---@field ResistCorprusDisease string
---@field ResistPoison string
---@field ResistNormalWeapons string
---@field ResistParalysis string
---@field RemoveCurse string
---@field TurnUndead string
---@field SummonScamp string
---@field SummonClannfear string
---@field SummonDaedroth string
---@field SummonDremora string
---@field SummonAncestralGhost string
---@field SummonSkeletalMinion string
---@field SummonBonewalker string
---@field SummonGreaterBonewalker string
---@field SummonBonelord string
---@field SummonWingedTwilight string
---@field SummonHunger string
---@field SummonGoldenSaint string
---@field SummonFlameAtronach string
---@field SummonFrostAtronach string
---@field SummonStormAtronach string
---@field FortifyAttack string
---@field CommandCreature string
---@field CommandHumanoid string
---@field BoundDagger string
---@field BoundLongsword string
---@field BoundMace string
---@field BoundBattleAxe string
---@field BoundSpear string
---@field BoundLongbow string
---@field ExtraSpell string
---@field BoundCuirass string
---@field BoundHelm string
---@field BoundBoots string
---@field BoundShield string
---@field BoundGloves string
---@field Corprus string
---@field Vampirism string
---@field SummonCenturionSphere string
---@field SunDamage string
---@field StuntedMagicka string
---@field SummonFabricant string
---@field SummonWolf string
---@field SummonBear string
---@field SummonBonewolf string
