...
description: Add H3's menu-only custom controls for screen positions and string lists.
weight: 82
extra:
  kind: api
---

{{ api_signature(value="H3 plugin → Settings renderers: ScreenPosition, List") }}
