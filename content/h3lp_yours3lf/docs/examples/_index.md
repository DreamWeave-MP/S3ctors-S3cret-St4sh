...
- [Debounced input](@/h3lp_yours3lf/docs/api/modules/debounce.md): refresh only after changes settle.
- [Periodic checks](@/h3lp_yours3lf/docs/api/modules/timing.md): poll without confusing interval coalescing with catch-up execution.
...
- [Migration](@/h3lp_yours3lf/docs/migration/from-local-helpers.md): compare a local helper with its H3 replacement using the same assertion.
