...
---@field combatTargets table<string, GameObject|tes3reference> a read-only table of combat targets, where keys are actor IDs and values are the actors themselves
