...
local Strings = {
  CantAutoAssignInterruptModeStr = 'Invalid Playlist Priority: %s for playlist: %s, cannot automatically assign interrupt mode!',
  ...
  FallbackPlaylistDoesntExist = 'Playlist %s requested to use tracks from backup playlist %s, but it isn\'t registered! Falling back to the default.',
  InitializationFinished = '[ S3MAPHORE ]: %d playlists loaded. Ready to play music!',
  InterruptModeFallthrough = 'Playlist Interrupt Modes Fell Through!\nOld Playlist: %s Interrupt Mode: %s\nNew Playlist: %s InterruptMode: %s',
  InvalidLevelDifferenceRule = 'Table %s for combatTargetLevelDifference rule does not contain either the relative OR absolute fields! You broke it!',
