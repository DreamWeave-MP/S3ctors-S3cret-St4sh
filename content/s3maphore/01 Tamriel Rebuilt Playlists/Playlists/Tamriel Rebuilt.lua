...
return {
  {
    ...
    isValidCallback = function() return Playback.state.nearestRegion == 'aanthirin region' end,
  },
  {
    ...
    isValidCallback = function() return Playback.rules.region(ThirrRegions) end,
  },
  {
    ...
    isValidCallback = function() return Playback.state.nearestRegion == 'armun ashlands region' end,
  },
  {
    ...
    isValidCallback = function() return Playback.state.nearestRegion == 'grey meadows region' end,
  },
  {
  ...
  },
  {
    ...
    isValidCallback = function() return Playback.rules.region(OrethanRegions) end,
  },
  {
  ...
  },
  {
    ...
    isValidCallback = function() return Playback.rules.region(MournholdRegions) end,
  },
  {
    ...
    isValidCallback = function() return Playback.rules.cellNameMatch(ImperialPatterns) end,
  },
  {
    ...
    isValidCallback = function() return Playback.rules.cellNameMatch(IndorilPatterns) end,
  },
  {
    ...
    isValidCallback = function() return Playback.rules.cellNameMatch(PortTelvannisPatterns) end,
  },
  {
    id = 'ms/cell/telcity',
    priority = PlaylistPriority.City,
    ...
    isValidCallback = function() return Playback.rules.cellNameMatch(TelvanniSettlementMatches) end,
  },
  {
    ...
    isValidCallback = function() return Playback.rules.cellNameMatch(TempleSettlementMatches) end,
  },
  {
    ...
    isValidCallback = function() return Playback.state.nearestRegion == 'sacred lands region' end,
  },
  {
    id = 'ms/region/seas',
    priority = PlaylistPriority.Region,
    ...
    isValidCallback = function() return Playback.rules.region(SeaRegions) end,
  },
  {
    ...
    isValidCallback = function() return Playback.rules.region(TelvannisRegions) end,
  },
  {
    ...
    isValidCallback = function() return Playback.rules.region(UpperVelothisRegions) end,
  },
}
