...
local function daedricEnemyRule()
  return Playback.state.isInCombat and Playback.rules.combatTargetExact(DaedricEnemyNames)
end

---@type ValidPlaylistCallback
local function daedricTilesetRule()
  return not Playback.state.isInCombat and Playback.rules.objectExact(Tilesets.Daedric)
end
