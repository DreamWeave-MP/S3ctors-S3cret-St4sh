...
local function shotnCityRule()
  return not Playback.state.isInCombat and Playback.rules.cellNameMatch(ShotnCityPatterns)
end

---@type ValidPlaylistCallback
local function shotnCombatCityRule()
  return Playback.state.isInCombat and Playback.rules.cellNameMatch(ShotnCityPatterns)
end
...
local function shotnRegionRule()
  return not Playback.state.isInCombat and Playback.rules.region(ShotnRegions)
end

---@type ValidPlaylistCallback
local function shotnCombatRegionRule()
  return Playback.state.isInCombat and Playback.rules.region(ShotnRegions)
end
