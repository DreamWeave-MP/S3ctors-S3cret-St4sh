...
local function categoryButton(recordType)
  ...
  button.props.relativeSize = util.vector2(0, 1)
  button.external = { stretch = .5, }

  local buttonProps = button.content[1].content[1].props
  -- button.content[1].content[1].external = { grow = 1, }
  buttonProps.textSize = 32
  ...
  return {
    ...
    content = ui.content {
...

      {
        ...
        props = {
          relativeSize = util.vector2(.85, 0),
        },
      },
