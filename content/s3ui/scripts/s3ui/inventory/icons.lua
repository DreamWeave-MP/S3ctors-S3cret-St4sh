...
M.MAIN_MENU_BUTTONS = {
    { key = 'inventory', icon = ui.texture { path = 'textures/s3ui/presets/coffee_ui/dark_s3ctor/menu/inventory.dds' } },
    ...
    { key = 'character', icon = ui.texture { path = 'textures/s3ui/presets/coffee_ui/dark_s3ctor/menu/character.dds' } },
}
