...
| --- | --- |
| `PopulatedVvardenfell_BalmoraWaterworks.yaml` | Moves NPC `1hlaalunpc35` to the published Balmora Waterworks coordinates for [Populated Vvardenfell](https://www.nexusmods.com/morrowind/mods/48955). |
| `ValitysBitterCoast_TwinLamps.yaml` | Disables refNum `361` from the published Vality's Bitter Coast addon in exterior cell `(-6, -7)`. |
