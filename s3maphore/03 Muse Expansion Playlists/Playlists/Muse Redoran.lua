...
local function redoranEnemyRule()
  return Playback.state.isInCombat and Playback.rules.combatTargetFaction(redoranFactionRule)
end
...
local function redoranCellRule()
  return not Playback.state.isInCombat and Playback.rules.cellNameMatch(RedoranCellNames)
end
