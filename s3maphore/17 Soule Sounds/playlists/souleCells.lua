...
local function ashlandersCellRule() return Playback.rules.cellNameMatch(AshlandersCellMatches) end
...
---@type ValidPlaylistCallback
local function clockworkCityRule() return Playback.rules.cellNameMatch(ClockworkcityCellMatches) end
...
---@type ValidPlaylistCallback
local function corprusariumCellRule() return Playback.rules.cellNameExact(corprusariumCells) end
...
---@type ValidPlaylistCallback
local function strongholdsRule() return Playback.rules.cellNameMatch(strongholdMatches) end
...
---@type ValidPlaylistCallback
local function grottosRule() return Playback.rules.cellNameMatch(grottoMatches) end
...
---@type ValidPlaylistCallback
local function hlaaluCellRule() return Playback.rules.cellNameMatch(HlaaluCellMatches) end
...
---@type ValidPlaylistCallback
local function minesRule() return Playback.rules.cellNameMatch(mineMatches) end
...
---@type ValidPlaylistCallback
local function nordicCellRule() return Playback.rules.cellNameMatch(nordicMatches) end
...
---@type ValidPlaylistCallback
local function oldMournholdRule() return Playback.rules.cellNameExact(oldMournholdCells) end
...
---@type ValidPlaylistCallback
local function redoranCellRule() return Playback.rules.cellNameMatch(redoranCellMatches) end
...
---@type ValidPlaylistCallback
local function sixthHouseBaseRule() return Playback.rules.cellNameMatch(sixthHouseBaseMatches) end
...
---@type ValidPlaylistCallback
local function sixthHouseCitadelRule() return Playback.rules.cellNameMatch(sixthHouseCitadels) end
...
---@type ValidPlaylistCallback
local function telvanniRule() return Playback.rules.cellNameMatch(telvanniCells) end
...
---@type ValidPlaylistCallback
local function templeCellRule() return Playback.rules.cellNameMatch(templeCells) end
...
---@type ValidPlaylistCallback
local function vampireBasesRule() return Playback.rules.cellNameExact(vampireBaseCells) end
...
---@type ValidPlaylistCallback
local function velothiTowersRule() return Playback.rules.cellNameExact(velothiTowerCells) end
...
---@type ValidPlaylistCallback
local function vivecRule() return Playback.rules.cellNameMatch(vivecMatches) end
