...
local function pilgrimageRule() return Playback.rules.cellNameExact(pilgrimageCells) end
...
local function valleyofthewindCellRule()
  return Playback.rules.exteriorGrid(valleyGrids) or Playback.rules.cellNameExact(valleyCells)
end
...
---@type ValidPlaylistCallback
local function sanctusShrineRule() return Playback.state.cellName == 'sanctus shrine' end
...
return {
  ...
  },
  {
    ...
    isValidCallback = function() return Playback.state.cellName == 'khartag point' end,
  },
  {
