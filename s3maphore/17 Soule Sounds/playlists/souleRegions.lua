...
local function azurasCoastRegionRule()
  return Playback.state.cellIsExterior and Playback.rules.region(AzurasCoastRegions)
end

---@type ValidPlaylistCallback
local function azurasCoastNightRegionRule()
  return azurasCoastRegionRule() and not Playback.rules.timeOfDay(6, 20)
end
...
local function moesringRegionRule()
  return Playback.state.cellIsExterior and Playback.rules.region(MoesringRegions)
end

---@type ValidPlaylistCallback
local function moesringNightRegionRule()
  return moesringRegionRule() and not Playback.rules.timeOfDay(6, 20)
end
...
local function ashlandsRegionRule()
  return Playback.state.cellIsExterior and Playback.rules.region(AshlandsRegions)
end
...
local function ascadianIslesRegionRule()
  return Playback.state.cellIsExterior and Playback.rules.region(AscadianislesRegions)
end

---@type ValidPlaylistCallback
local function ascadianislesNightRegionRule()
  return ascadianIslesRegionRule() and not Playback.rules.timeOfDay(7, 20)
end
...
local function mournholdRegionRule()
  return Playback.state.cellIsExterior and Playback.rules.region(MournholdRegions)
end
...
local function redMountainRegionRule()
  return Playback.state.cellIsExterior and Playback.rules.region(redMountainRegions)
end

---@type ValidPlaylistCallback
local function redMountainNightRegionRule()
  return redMountainRegionRule() and not Playback.rules.timeOfDay(7, 20)
end
...
local function solstheimRegionRule()
  return Playback.state.cellIsExterior and Playback.rules.region(SolstheimRegions)
end

---@type ValidPlaylistCallback
local function solstheimNightRegionRule()
  return solstheimRegionRule() and not Playback.rules.timeOfDay(7, 20)
end
...
local function westGashRegionRule()
  return Playback.state.cellIsExterior and Playback.rules.region(WestgashRegions)
end

---@type ValidPlaylistCallback
local function westGashNightRegionRule()
  return westGashRegionRule() and not Playback.rules.timeOfDay(7, 20)
end
