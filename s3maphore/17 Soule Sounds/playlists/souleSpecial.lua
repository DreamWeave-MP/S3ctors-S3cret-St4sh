...
local function highFaneRule() return Playback.state.cellName == 'vivec, high fane' end
...
---@type ValidPlaylistCallback
local function vivecLibraryRule() return Playback.rules.cellNameExact(vivecLibraryCells) end
...
---@type ValidPlaylistCallback
local function ministryOfTruthRule() return Playback.rules.cellNameExact(ministryOfTruthCells) end

---@type ValidPlaylistCallback
local function vivecpalaceCellRule() return Playback.state.cellName == 'vivec, palace of vivec' end

---@type ValidPlaylistCallback
local function puzzleCanalRule() return Playback.state.cellName == 'vivec, puzzle canal, center' end
...
---@type ValidPlaylistCallback
local function tribunalTempleRule() return Playback.rules.cellNameExact(tribunalTempleCells) end
...
---@type ValidPlaylistCallback
local function urshilakuRule() return Playback.rules.cellNameExact(urshilakuMatches) end
...
---@type ValidPlaylistCallback
local function shrineofazuraCellRule() return Playback.rules.cellNameExact(azuraShrine) end
...
---@type ValidPlaylistCallback
local function mephalaShrineRule() return Playback.rules.cellNameExact(mephalaShrine) end
...
---@type ValidPlaylistCallback
local function sheoShrineRule() return Playback.rules.cellNameExact(sheoShrine) end
...
---@type ValidPlaylistCallback
local function mournholdPlazaRule() return Playback.rules.cellNameExact(mournholdCells) end
...
---@type ValidPlaylistCallback
local function meadhallRule() return Playback.rules.cellNameMatch(MeadhallMatches) end
...
---@type ValidPlaylistCallback
local function hlaaluManorRule() return Playback.rules.cellNameExact(hlaaluManorCells) end
...
---@type ValidPlaylistCallback
local function holamayanCellRule() return Playback.rules.cellNameExact(holamayanCells) end
...
---@type ValidPlaylistCallback
local function frostmothRule() return Playback.rules.cellNameExact(frostmothCells) end
...
local function ghostgateRule()
  return Playback.rules.exteriorGrid(ghostgateGrids) or Playback.rules.cellNameExact(ghostgateCells)
end

---@type ValidPlaylistCallback
local function incarnateCellRule() return Playback.state.cellName == 'cavern of the incarnate' end
...
return {
  ...
  },
  {
    ...
    isValidCallback = function() return Playback.state.cellName == 'imperial prison ship' end,
  },
  {
